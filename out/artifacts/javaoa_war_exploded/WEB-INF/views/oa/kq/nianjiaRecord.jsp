...
<div style="margin: 10px 5px 0 195px; padding-bottom:15px;">
	...
	<div style="margin-top:10px;position:relative; line-height:20px; height:22px; border-bottom:1px solid #ccc;">
		<div style="width:120px; color:#34495E;border-bottom:2px solid #27AE60; padding-left:10px; font-size:14px; font-weight:bold;">${emp.name }${requestScope.type }记录</div>
	    	...
	    	<c:forEach items="${list}" var="cur">
	    		...
	    		<tr style="color:red;">
					...
					<c:if test="${cur.bz == '请假扣除' }">
						...
						-->
						<a href="javascript:submitFormId(${cur.leaveId})">${cur.bz }</a>
						</c:if>
						<c:if test="${cur.leaveId ==0 }">
...
<form name="formId" action="${ctx }/web/oa/leave/showNjDetail" method="post">
