...
<div
	...
	<div style="margin: 10px 5px 0 195px; padding-bottom: 15px;">
		...
		<div class="lzui-tooltips"
			...
			<a style="color: #C0392B;" href="${ctx}/web/oa/leave/goCancelLeave">点击请假注销</a>
		</div>
			...
			<table class="lzzUIGrid">
				<tbody>
					...
					<tr>
						...
						<td class="l-td-header l-td-left" style="width: 130px;">销假时长</td>
    				...
    				${cur.minutes }分钟
							...
							<td class="l-td"><a
								href="${ctx }/web/oa/leave/findCancel/${cur.id}">查看详情</a></td>
						</tr>
					</c:forEach>
...
function goPageAction(curpage) {
	location.href="${ctx}/web/oa/leave/findAllXj?curpage="+curpage;
}
</script>
</html>