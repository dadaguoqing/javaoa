...
<div style="margin: 10px 5px 0 195px;">
	...
	<table class="lzzUIGrid"><tbody>
		...
		<tr>
			...
			<td class="l-td-header l-td-left" style="width:60px;">代理人</td>
			<td class="l-td-header" style="width:160px;">申请时间</td>
			<td class="l-td-header l-td-left" style="">有效时间</td>
    	...
    	<c:forEach items="${list}" var="cur">
    		...
    		<tr class="detailTr" id="t${cur.id}" style="display:none;">
    			<td class="l-td l-td-left" colspan="6" style="color:blue; font-weight:bold;">
    				${cur.content}
				</td>
    		</tr>
    	</c:forEach>
...
function submitSp(id,sp){
	...
	var msg = ( sp == 1 ? "同意之后，权限代理将立即生效。确定操作？" : "您确定不同意这个申请？" );
	if(confirm(msg)){
		yj = encodeURIComponent(yj);
		url = "${ctx}/web/oa/asp/dlsp/"+id+"/"+sp+"?yj="+yj;
		location.href= url;
	}
}
</script>
