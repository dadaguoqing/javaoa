...
<div style="margin: 10px 5px 0 195px;">
	...
	<table class="lzzUIGrid"><tbody>
		...
		<tr>
			...
			<td class="l-td-header l-td-left" style="">申请内容</td>
			<td class="l-td-header" style="width:80px;">审批状态</td>
    	...
    	<c:forEach items="${list}" var="cur">
    		<tr>
    			...
    			<td class="l-td">
    				<a href="javascript:showDetail(${cur.id });">查看详情</a>
				</td>
    		</tr>
    		<tr class="detailTr" id="t${cur.id}" style="display:none;">
    			<td class="l-td l-td-left" colspan="5" style="color:blue; ">
    				<span style="color:red; font-weight:bold;">申请内容：</span>${cur.content}<br/>
    				<span style="color:red; font-weight:bold;">审批意见：</span>${cur.cmt}
				</td>
    		</tr>
    	</c:forEach>
