...
<div
	...
	<div id="theNavigater">
		...
		<div class="navTitle2 cur" url="javascript:;">
			<img src="${ctx }/resources/images/item.png"
				style="vertical-align: middle; width: 20px; height: 20px;" />&nbsp;&nbsp;新增供应商
		</div>
	...
	<div style="margin: 10px 5px 0 195px;">
		...
		<form id="form1" name="form1" action="${ctx }/web/oa/merchandise/manage/addSupplier"
			method="post">
			<input type="hidden" value="${submitCode}" name="submitCode" />
			<div style="border: 1px solid #2191C0;">
				<div class="main-header" id="id1">
					<span style="color: #eee;">新增供应商</span>
				</div>
				...
				<table class="table1">
					<tbody>
						<tr>
							...
							<td><input name="code" id="code" style="width: 300px;" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<textarea rows="4" cols="41" name="address" id="address"></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<textarea rows="4" cols="41" name="content" id="content" ></textarea></td>
						</tr>
					</tbody>
				</table>
			</div>
