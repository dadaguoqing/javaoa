...
<div style="margin: 10px 5px 0 195px;">
	...
	<div class="lzui-tooltips" style="margin:10px; color:#C0392B; font-weight:bold; font-size:14px;">
  		<a style="color:#C0392B;" href="${ctx}/web/oa/waichu/mysp">点击返回出差审批</a>
  	</div>
	...
	<table class="lzzUIGrid"><tbody>
		...
		<tr>
			...
			<td class="l-td-header l-td-last-right" style="">审核结果</td>
    	...
    	<c:forEach items="${list}" var="cur">
    		<tr>
    			...
    			<td class="l-td l-td-left">${cur.sqName }</td>
    			<td class="l-td">
    				${cur.sqTime }
				</td>
				...
				<td class="l-td l-td-last-right" style="">
					<a href="${ctx}/web/oa/waichu/showForSpRecord/${cur.tid}">查看详情</a>
				</td>
    		</tr>
    	</c:forEach>
