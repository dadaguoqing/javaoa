...
<div id="theNavigater">
	...
	<div class="navTitle2" url="${ctx }/web/oa/waichu/myWaichuCancelSp"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;返回上级</div>
</div>
...
<div style="margin: 10px 5px 0 195px;">
	...
	<form name="form1" action="${ctx }/web/oa/waichu/spWaichuCancel" method="post" onsubmit="return beforeSubmit();">
	
	<input type="hidden" value="${submitCode}" name="submitCode"/>
	<input type="hidden" value="${leave.id}" name="id"/>
	<div style="border:1px solid #2191C0; ">
	<div class="main-header" id="id1">
		<span style="color:#eee;">${compName }<span style=" ">出差注销申请单</span></span>
	</div>
	<div class="tableTitle" style="padding:10px 20px;">
		<span>
		<img src="${ctx }/resources/images/communication.gif"/>&nbsp;&nbsp;&nbsp;&nbsp;
