...
<div style="margin: 10px 5px 0 195px;">
	...
	<div class="lzui-tooltips" style="margin:10px; color:#C0392B; font-weight:bold; font-size:14px;">
  		<a style="color:#C0392B;" href="${ctx}/web/oa/prop/zyRecord">资产转移记录</a>
  	</div>
	
	<form name="form1" action="${ctx }/web/oa/prop/zy" method="post">
	...
	<table class="table1" ><tbody>
		<tr>
			<td class="title" style="width:120px;"><span style="color:red;">*</span>申请(转出)人：</td>	
			<td style="width:90px;">
				<a href="javascript:chooseUser(1);">请选择</a>
				<span id="zcEmpName"></span>
				<input type="hidden" id="zcEmpId" name="zcEmpId"/>
			</td>	
			<td class="title" style="width:120px;"><span style="color:red;">*</span>转入人：</td>	
			<td style="width:90px;">
				<a href="javascript:chooseUser(2);">请选择</a>
				<span id="unameSpan"></span>
				<input type="hidden" id="uid" name="uid"/>
			</td>
			<!--  
			<td class="title" style="width:120px;">申请(转出)部门：</td>	
			<td style="width:90px;">
				${loginUserDept.name }
			</td>
			-->
...
$(function(){
	...
	$('#crbtn').click(function(){
		...
		index = $.layer({
		    ...
		    border: [3],
		    shadeClose: false,
		    iframe: {src : '${ctx}/web/oa/prop/choosePropByEmp?empId='+zcEmp},
		    area: ['850px', '500px'],
