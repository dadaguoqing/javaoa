...
<div style="margin: 10px 5px 0 195px;">
	...
	<div style="width:72px; color:#34495E;border-bottom:2px solid #27AE60; padding-left:10px; font-size:14px; font-weight:bold;">上传照片</div>
	</div>
	<form name="form1" action="${ctx }/web/upload/photo" method="post" enctype="multipart/form-data">
	<div style="border:1px solid #2191C0; ">
	<div class="main-header" id="id1">
		<span style="color:#eee;">上传照片</span>
	</div>
	...
	<table class="table1" ><tbody>
		<tr>
			<td class="title" style="border-left:none; width:140px;">请选择一张您的照片：</td>	
			<td style=" border-right:none;" colspan="3">
				<input type="file" name="photo" id="photo"/> &nbsp;
				<span style="color:red;">照片尺寸100*100px，不能大于1mb</span>
			</td>	
		</tr>
	</tbody></table>
