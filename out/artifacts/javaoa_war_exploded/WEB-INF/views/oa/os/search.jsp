...
<div style="margin: 10px 5px 0 195px; padding-bottom:20px;">
	...
	<div class="tableTitle" style="border-bottom: 1px dotted #aaaaaa; padding-bottom:5px;">
		...
		查询条件</div>
	<form name="sForm"  method="post" id="sForm" action="${ctx}/web/oa/os/seach">
	...
	<table id="baseInfoTable">
		<tr>
			...
			<a  id="smbtn" class="lzui-btn lzui-corner-all" style="padding:0px 20px;">导出消耗记录</a>
				</div>
			</td>
		</tr>
	</table>
...
$(function(){
	...
	$('#sBtn').click(function(){
		document.sForm.action="${ctx}/web/oa/os/seach"
		sForm.submit();
	});
	$('#smbtn').click(function(){
		document.sForm.action="${ctx }/web/oa/os/exportConsume";
		sForm.submit();
	});
});
