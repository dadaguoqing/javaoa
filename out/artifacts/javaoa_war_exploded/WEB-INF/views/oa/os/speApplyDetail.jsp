...
<div style="margin: 10px 5px 0 195px;">
	<div style="margin-top:10px;position:relative; line-height:20px; height:22px; border-bottom:1px solid #ccc; width:960px;">
		<div style="width:120px; color:#34495E;border-bottom:2px solid #27AE60; padding-left:10px; font-size:14px; font-weight:bold;">特别申请记录</div>
	</div>
	...
	<div class="lzui-tooltips" style="margin:10px; color:#C0392B; font-weight:bold; font-size:14px;">
  		<a style="color:#C0392B;" href="${ctx}/web/oa/os/speApplyList">点击返回办公用品特别申列表</a>
  	</div>
	...
	<table class="table1" id='cdTable' ><tbody>
		...
		<a href="javascript:sendMessage(${sq.id });" class="lzui-btn lzui-corner-all">可以领用</a>
	</div>
...
function sendMessage(id){
	var flag = confirm("确定物品已入库，可以领用？");
	if(flag){
		document.location.href = "${ctx}/web/oa/os/sendMessage?id="+id;
	}
}
</script>