...
<div class="navTitle2 cur" url="javascript:;"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;申请详情</div>
	<div class="navTitle2" url="${ctx }/web/oa/os/ypCgSp"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;返回上级</div>
	</div>
...
<div style="margin: 10px 5px 0 195px;">
	...
	<form name="form1" action="${ctx }/web/oa/os/ypCgSp2" method="post" onsubmit="return beforeSubmit();">
	...
	<table class="table1" id='cdTable' ><tbody>
		...
		<tr style="color:red; font-weight:bold;">
			...
			<td class="title" style="text-align:left; width:100px; " id="zjje">
