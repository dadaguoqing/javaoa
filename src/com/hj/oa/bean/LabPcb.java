...
public class LabPcb implements Serializable{

	private static final long serialVersionUID = 1L;

	@Override
	public String toString() {
		return "LabPcb [表面涂层=" + bmtc + ", 表面涂层厚度=" + bmtchd + ", 尺寸长="
				+ ccChang + ", 尺寸宽=" + ccKuang + ", cl=" + cl + ", 成品板厚="
				+ cpbh + ", 成品检测报告=" + cpjcbg + ", 头版时间=" + createTime
				+ ", cs=" + cs + ", cstd=" + cstd + ", cstdType=" + cstdType
				+ ", dcbg=" + dcbg + ", ddbh=" + ddbh + ", fgzh=" + fgzh
				+ ", 文件名=" + fileName + ", 文档目录=" + filePath
				+ ", gyyq=" + gyyq + ", id=" + id + ", jszyq=" + jszyq
				+ ", kzms=" + kzms + ", numSet=" + numSet + ", numUnit="
				+ numUnit + ", tbNei=" + tbNei + ", tbWai=" + tbWai
				+ ", wxjgfs=" + wxjgfs + ", zf=" + zf + ", zfColor=" + zfColor
				+ ", zh=" + zh + ", zhColor=" + zhColor + ", zkcsbg=" + zkcsbg
				+ "]";
	}
