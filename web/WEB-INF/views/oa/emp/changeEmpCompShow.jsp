...
<div style="margin: 10px 5px 0 195px;">
	...
	<div style="width:108px; color:#34495E;border-bottom:2px solid #27AE60; padding-left:10px; font-size:14px; font-weight:bold;">上传资格认证</div>
	</div>
	<form name="form1" action="${ctx }/web/upload/empCompPdf" method="post" enctype="multipart/form-data">
	<div style="border:1px solid #2191C0; ">
	<div class="main-header" id="id1">
		<span style="color:#eee;">上传资格认证pdf</span>
	</div>
