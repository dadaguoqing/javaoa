...
<div
	...
	<div id="theNavigater">
		...
		<div class="navTitle2 cur" url="javascript:;">
			<img src="${ctx }/resources/images/item.png"
				style="vertical-align: middle; width: 20px; height: 20px;" />&nbsp;&nbsp;客户信息修改
		</div>
		<div class="navTitle2"
	...
	<form id="form1" name="form1" action="${ctx }/web/oa/product/receiver/update" method="post">
	<div style="border:1px solid #2191C0; ">
	<div class="main-header" id="id1">
		<span style="color:#eee;">客户信息修改</span>
	</div>
	...
	<table class="table1" ><tbody>
		<tr>
			<td class="title">客户编号 <span style="color:red;">*</span>：</td>	
			<td>
				<input name="companyCode" id="companyCode" value="${company.companyCode }"/>
			</td>	
		</tr>
		<tr>
			...
			<td>
				...
				<input name="company" id="company" value="${company.company }"/>
			</td>	
		</tr>
		<tr>
			<td class="title">收货地址 <span style="color:red;">*</span>：</td>	
			<td>
				<input name="addr" id="addr" value="${company.addr }"/>
			</td>	
		</tr>
		<tr>
			<td class="title">收货人 <span style="color:red;">*</span>：</td>	
			<td>
				<input name="receiver" id="receiver" value="${company.receiver }"/>
			</td>	
		</tr>
		<tr>
			<td class="title">联系电话 <span style="color:red;">*</span>：</td>	
			<td>
				<input name="tel" id="tel" value="${company.tel }"/>
			</td>	
		</tr>
		<tr>
			...
			<td>
				<select id="state" name="state">
					<option value="1" <c:if test="${company.state == 1}">selected</c:if>>启用</option>
					<option value="0" <c:if test="${company.state == 0}">selected</c:if>>禁用</option>
				</select>
			</td>	
		</tr>
	</tbody></table>
