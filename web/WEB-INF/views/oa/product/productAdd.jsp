...
<div
	...
	<div id="theNavigater">
		...
		<div class="navTitle2 cur" url="javascript:;">
			<img src="${ctx }/resources/images/item.png"
				style="vertical-align: middle; width: 20px; height: 20px;" />&nbsp;&nbsp;产品新增
		</div>
		<div class="navTitle2"
	...
	<form id="form1" name="form1" action="${ctx }/web/oa/product/add" method="post">
	<div style="border:1px solid #2191C0; ">
	<div class="main-header" id="id1">
		<span style="color:#eee;">产品新增</span>
	</div>
	...
	<table class="table1" ><tbody>
		<tr>
			...
			<td>
				<input name="productModel" id="productModel"/>
			</td>	
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<textarea id="remark" name="remark" cols="22" rows="5" placeholder="100个字符以内"></textarea>
			</td>	
		</tr>
	</tbody></table>
	</div>
