...
<div
	...
	<div style="margin: 10px 5px 0 195px;">
		...
		<div class="lzui-tooltips"
			...
			<a style="color: #C0392B;" href="${ctx}/web/oa/product/outstock/approval/list">点击这里返回</a>
		</div>
			...
			<table class="lzzUIGrid">
				<tbody>
					...
					<tr>
						...
						<td class="l-td-header" style="width: 200px;">申请人</td>
					...
					<c:forEach items="${records}" var="cur">
						<tr>
							...
							<td class="l-td l-td-left">${cur.proposer}</td>
							...
							<td class="l-td"><a
								href="${ctx }/web/oa/product/approval/records/${cur.id}">查看详情</a></td>
						</tr>
					</c:forEach>
