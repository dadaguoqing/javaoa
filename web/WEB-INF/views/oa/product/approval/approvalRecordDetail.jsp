...
<div
	...
	<div id="theNavigater">
		...
		<div class="navTitle2"
			url="${ctx }/web/oa/product/outstock/approval/records">
			<img src="${ctx }/resources/images/item.png"
	...
	<div style="margin: 10px 5px 0 195px;">
		...
		<div class="lzui-tooltips"
			...
			<a style="color: #C0392B;"
				href="${ctx}/web/oa/product/outstock/approval/records">点击查看审批记录</a>
		</div>
									...
									<c:if test="${not empty outRecord.shipmentReceiveNum }">
										<tr>
											...
											<td class="title" style="text-align: right; width: 100px;">
												物流单照片</td>
											<td><a
												href="javascript:openPage('${outRecord.shipmentReceivePic}');">${fn:split(outRecord.shipmentReceivePic, '/')[fn:length(fn:split(outRecord.shipmentReceivePic, '/'))-1]}</a></td>
										</tr>
									</c:if>
								</c:forEach>
							</c:if>
