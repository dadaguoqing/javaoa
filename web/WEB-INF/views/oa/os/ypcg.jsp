...
<div style="margin: 10px 5px 0 195px;">
	...
	<div class="lzui-tooltips" style="margin:10px; color:#C0392B; font-weight:bold; font-size:14px;">
  		<a style="color:#C0392B;" href="${ctx}/web/oa/os/myYpCgRecord">点击查看申请记录</a>
  	</div>
	
	<form name="form1" action="${ctx }/web/oa/os/ypcg" method="post">
	...
	<table class="table1" id='cdTable' ><tbody>
		...
		<tr id="addCdTr">
			...
			<td style="color:red;">
				<input style="width:20px;" id="numSpan" onblur="jsjr();"/><span id="unitSpan">&nbsp;</span>
			</td>
			<td style="color:red;">
