...
<div id="theNavigater">
	...
	<div class="navTitle2 cur" url="javascript:;"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;编辑药品信息</div>
...
<div style="margin: 10px 5px 0 195px;">
	...
	<form name="form1" action="${ctx }/web/oa/os/editYp" method="post" enctype="multipart/form-data">
	<input type="hidden" value="${submitCode}" name="submitCode"/>
	<input type="hidden" value="${yp.id }" name="id"> 
	...
	<table class="table1" ><tbody>
		<tr>
			<td  style="border-right:none; ">
				...
				<span style="color:red;">如果需要，请重新上传药品详情pdf文档</span>
			</td>	
		</tr>
	</tbody></table>
	...
	<div class="" style="margin-top:10px; margin-bottom:20px;">
		<a href="javascript:submitForm();" class="lzui-btn lzui-corner-all">点击编辑</a>
	</div>
