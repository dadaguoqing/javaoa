...
<div style="margin: 10px 5px 0 195px;">
	...
	<div class="lzui-tooltips" style="margin:10px; color:#C0392B; font-weight:bold; font-size:14px;">
  		<a style="color:#C0392B;" href="${ctx}/web/oa/os/wpcg">返回办公用品采购申请</a>
  	</div>
	...
	<table class="lzzUIGrid"><tbody>
		<tr>
			<td class="l-td-toolbar" colspan="9">
		...
		<tr>
			...
			<td class="l-td-header" style="width:100px;">修改</td>
    	...
    	<c:forEach items="${list}" var="cur">
    		<tr>
    			...
    			<td class="l-td">
    					<c:choose>
    					<c:when test="${cur.status == -1}">
    				<a href="${ctx }/web/oa/os/wpcg/${cur.id}">修改</a>
    					</c:when>
    				</c:choose>
				</td>
    			<td class="l-td">
    				<a href="${ctx }/web/oa/os/myWpCgDetail/${cur.id}">查看详情</a>
				</td>
    		</tr>
    	</c:forEach>
