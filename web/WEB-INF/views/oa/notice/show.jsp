...
<div id="theNavigater">
	...
	<div class="navTitle2 cur" url="${ctx}/web/oa/index" ><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;修改密码</div>
	<div class="navTitle2" url="${ctx }/web/login" ><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;系统登陆</div>
