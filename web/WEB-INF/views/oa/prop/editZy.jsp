...
<div id="theNavigater">
	...
	<div class="navTitle2" url="${ctx }/web/oa/prop/myZySp"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;返回上级</div>
</div>
...
<div style="margin: 10px 5px 0 195px;">
	...
	<form name="form1" action="${ctx }/web/oa/prop/zySp" method="post" onsubmit="return beforeSubmit();">
