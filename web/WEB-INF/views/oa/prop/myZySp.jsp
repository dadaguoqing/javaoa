...
<div style="margin: 10px 5px 0 195px;">
	...
	<table class="lzzUIGrid"><tbody>
		...
		<tr>
			<td class="l-td-header l-td-left" style="width:70px;">转出人</td>
			<td class="l-td-header l-td-left" style="width:70px;">转入人</td>
    	...
    	<c:forEach items="${list}" var="cur">
    		<tr>
    			...
    			<td class="l-td">
    				<a href="${ctx }/web/oa/prop/editZy/${cur.id}">查看详情</a>
				</td>
    		</tr>
    	</c:forEach>
