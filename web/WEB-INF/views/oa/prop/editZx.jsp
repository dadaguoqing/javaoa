...
<div id="theNavigater">
	...
	<div class="navTitle2" url="${ctx }/web/oa/prop/myZxSp"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;返回上级</div>
</div>
...
<div style="margin: 10px 5px 0 195px;">
	<div style="margin-top:10px;position:relative; line-height:20px; height:22px; border-bottom:1px solid #ccc; width:960px;">
		<div style="width:93px; color:#34495E;border-bottom:2px solid #27AE60; padding-left:10px; font-size:14px; font-weight:bold;">资产注销申请</div>
	</div>
	...
	<form name="form1" action="${ctx }/web/oa/prop/zxSp" method="post" onsubmit="return beforeSubmit();">
	...
	<table class="table1" ><tbody>
		<tr>
			...
			<td class="title" style="width:100px;">注销原因：</td>	
			<td style="width:90px;">
				${sq.reason}
			</td>
