...
<div style="margin: 10px 5px 0 195px;">
	...
	<div class="lzui-tooltips" style="margin:10px; color:#C0392B; font-weight:bold; font-size:14px;">
  		<a style="color:#C0392B;" href="${ctx}/web/oa/prop/cgrk">待处理资产采购列表 </a>
  	</div>
  	<form id="form1" name="form1" action="${ctx}/web/oa/prop/exportPurchaseRecord" method="post">
  	<table>
  		<td>
  		...
  		<td>
			<a id="smbtn" class="lzui-btn lzui-corner-all" style="padding:0px 20px;">导出记录</a>
  		</td>
  	</table>
  	</form>
	...
	<table class="lzzUIGrid"><tbody>
    	...
    	<c:forEach items="${list}" var="cur">
    		<tr>
    			...
    			<td class="l-td">
    				<a href="${ctx }/web/oa/prop/cgDetail/${cur.id}">查看详情</a>
				</td>
    		</tr>
    	</c:forEach>
