...
<div id="theNavigater">
	...
	<div id="固定资产维修" class="navTitle2" url=""><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;固定资产维修</div>
</div>
...
<div style="margin: 10px 5px 0 195px;">
	<div style="margin-top:10px;position:relative; line-height:20px; height:22px; border-bottom:1px solid #ccc; width:960px;">
		<div style="width:123px; color:#34495E;border-bottom:2px solid #27AE60; padding-left:10px; font-size:14px; font-weight:bold;">固定资产维修申请</div>
	</div>
	...
	<form name="form1" action="${ctx }/web/oa/prop/wxSq" method="post">
	...
	<table class="table1" id='cdTable' ><tbody>
		<tr>
			...
			<td class="title" style="text-align:left; width:100px; ">
				<span style="color:red;">*</span>预计费用
			</td>		
		</tr>
		...
		<tr id="addCdTr">
			...
			<td style=" width:60px; border-right:none; ">
				<input type="text" style="width:40px;" name="money" id="money"/>元 
			</td>		
		</tr>
