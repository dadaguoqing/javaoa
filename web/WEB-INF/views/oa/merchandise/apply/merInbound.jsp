...
<div
	...
	<div style="margin: 10px 5px 0 195px;">
		...
		<div class="lzui-tooltips"
			...
			<a style="color: #C0392B;" href="${ctx}/web/oa/merchandise/apply/recordList/1/1?curPage=1">查看申请记录</a>
		</div>

		<form name="form1" action="${ctx }/web/oa/merchandise/apply/saveMerInbound" id="form1"
			method="post" >
