...
<div
	...
	<div id="theNavigater">
		...
		<div class="navTitle2 cur" url="javascript:;">
			...
			<div class="navTitle2" url="${ctx }/web/oa/merchandise/apply/recordList/2/${type}?curPage=1">
				<img src="${ctx }/resources/images/item.png"
				...
				<div
					...
					<table class="table1">
						<tbody>
							...
							<tr>
								...
								<td class="title" style="">预计出库时间：</td>
					...
					<table class="table1" id='cdTable'>
						<tbody>
							...
							<td class="title" style="text-align: center; width: 80px;">出库原因</td>
