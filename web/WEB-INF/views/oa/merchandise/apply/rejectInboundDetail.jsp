...
<div
	...
	<div id="theNavigater">
		...
		<div class="navTitle2 cur" url="javascript:;">
			...
			<div class="navTitle2" url="${ctx }/web/oa/merchandise/apply/recordList/${applyType}/${type}?curPage=1">
				<img src="${ctx }/resources/images/item.png"
				...
				<div
					...
					<table class="table1" id='cdTable'>
						<tbody>
							...
							<td class="title" style="text-align: center; width: 130px;">入库原因</td>
							...
							<c:forEach items="${list}" var="detail" varStatus="i">
								<tr>
									...
									<td class="limitText" title="${detail.inboundReason}">${detail.inboundReason}</td>
