	...
	<div style="margin: 10px 5px 0 195px;">
		...
		<c:if test="${type == 1}">
			<div class="lzui-tooltips"
				...
				<a style="color: #C0392B;" href="${ctx}/web/oa/merchandise/apply/merOutbound">返回</a>
			</div>
		</c:if>
		<c:if test="${type == 2}">
			<div class="lzui-tooltips"
				...
				<a style="color: #C0392B;"
					href="${ctx}/web/oa/merchandise/apply/recordList/2/3">查看审批记录</a>
			</div>
		</c:if>
				...
				<tbody>
					...
					<c:forEach items="${list}" var="cur">
						<tr>
							...
							<td class="l-td"><a
								href="${ctx }/web/oa/merchandise/apply/recordDetail/2/${type}?id=${cur.id}">查看详情</a></td>
						</tr>
					</c:forEach>
