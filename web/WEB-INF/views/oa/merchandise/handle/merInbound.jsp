		...
		<c:if test="${param.msg == 1}">
			...
			<div class="lzui-tooltips"
				...
				<a style="color: #C0392B;"
					href="${ctx}/web/oa/merchandise/handle/1/2">查看记录</a>
			</div>
				...
				<tbody>
					...
					<c:forEach items="${list}" var="cur">
						<tr>
							...
							<td class="l-td"><a
								href="${ctx }/web/oa/merchandise/handle/merInbound/detail/1?id=${cur.id}">查看详情</a></td>
						</tr>
					</c:forEach>
...
<script>
	onload = function() {
	    //用用回调
	    function go(p) {
	    	location.href = '${ctx}/web/oa/merchandise/handle/1/1?curPage=' + p;
