...
<div
	...
	<div id="theNavigater">
		...
		<div class="navTitle2 cur" url="javascript:;">
			...
			<div class="navTitle2" url="${ctx }/web/oa/merchandise/handle/5/${type2}">
				<img src="${ctx }/resources/images/item.png"
				...
				<div
					...
					<table class="table1">
						<tbody>
							<tr>
								...
								<td style="border-right: none;">${app.applyDate}</td>
					...
					<table class="table1" id='cdTable'>
						<tbody>
							...
							<td class="title" style="text-align: center; width: 100px;">入库原因</td>
							...
							<c:forEach items="${list}" var="detail" varStatus="i">
								<tr>
									...
									<td class="limitText" title="${detail.weekCode}">${detail.inboundSource}</td>
									<td class="limitText" title="${detail.inboundSource}">${detail.inboundReason}</td>
					...
					<table class="table1">
							<tbody>
									<tr>
										...
										<td class="title" style="text-align: center; width: 50px;">单位</td>
										<td class="title" style="text-align: center; width: 150px;">生产信息代码</td>
										<td class="title" style="text-align: center; width: 100px;">入库来源</td>
...
<script>
	...
	function submitForm() {
		...
		$.ajax({
            ...
            success : function(r) {
				if(r.success == 1) {
					location.href = "${ctx}/web/oa/merchandise/handle/5/1?msg=1";
				} else {
					layer.alert(r.msg);
				}
            }
