...
<div
	...
	<div style="margin: 10px 5px 0 195px;">
		...
		<div class="lzui-tooltips"
			...
			<a style="color: #C0392B;" href="${ctx}/web/oa/external/approveList">返回</a>
		</div>
				...
				<tbody>
					...
					<c:forEach items="${list}" var="cur">
						<tr>
							...
							<td class="l-td"><a
								href="${ctx }/web/oa/external/detail/approveRecord?id=${cur.id}">查看详情</a></td>
						</tr>
					</c:forEach>
...
<script>
	onload = function() {
	    //用用回调
	    function go(p) {
	    	location.href = '${ctx}/web/oa/external/approveRecordList?curPage=' + p;
	    }
