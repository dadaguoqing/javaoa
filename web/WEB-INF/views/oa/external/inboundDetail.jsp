...
<div
	...
	<div id="theNavigater">
		...
		<div class="navTitle2 cur" url="javascript:;">
			...
			<div class="navTitle2" url="${ctx }/web/oa/external/inboundList">
				<img src="${ctx }/resources/images/item.png"
							...
							<c:if test="${type == '1' }">
								<c:if test="${empty ei1.inboundNum}">
									<tr>
										...
										<td colspan="3"><a href="javascript:void(0);" onclick="inbound(1)">入库</a></td>
									</tr>
								</c:if>
							...
							<c:if test="${type == '2' }">
								<c:if test="${empty ei2.inboundNum}">
									<tr>
										...
										<td colspan="3"><a href="javascript:void(0);" onclick="inbound(2)">入库</a></td>
									</tr>
								</c:if>
							...
							<c:if test="${type == '3' }">
								<c:if test="${empty ei3.inboundNum}">
									<tr>
										...
										<td colspan="3"><a href="javascript:void(0);" onclick="inbound(3)">入库</a></td>
									</tr>
								</c:if>
							...
							<c:if test="${type == '4' }">
								<c:if test="${empty ei4.inboundNum}">
									<tr>
										...
										<td colspan="3"><a href="javascript:void(0);" onclick="inbound(4)">入库</a></td>
									</tr>
								</c:if>
							...
							<c:if test="${type == '5' }">
								<c:if test="${empty ei5.inboundNum}">
									<tr>
										...
										<td colspan="3"><a href="javascript:void(0);" onclick="inbound(5)">入库</a></td>
									</tr>
								</c:if>
							...
							<c:if test="${type == '6' }">
								<c:if test="${empty ei6.inboundNum}">
									<tr>
										...
										<td colspan="3"><a href="javascript:void(0);" onclick="inbound(6)">入库</a></td>
									</tr>
								</c:if>
							...
							<c:if test="${type == '7' }">
								<c:if test="${empty ei7.inboundNum}">
									<tr>
										...
										<td colspan="3"><a href="javascript:void(0);" onclick="inbound(7)">入库</a></td>
									</tr>
								</c:if>
							...
							<c:if test="${type == '8' }">
								<c:if test="${empty ei8.inboundNum}">
									<tr>
										...
										<td colspan="3"><a href="javascript:void(0);" onclick="inbound(8)">入库</a></td>
									</tr>
								</c:if>
