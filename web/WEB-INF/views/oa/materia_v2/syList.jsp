	...
	<div style="margin: 10px 5px 0 195px;">
		...
		<c:if test="${type == 1}">
			<div class="lzui-tooltips"
				...
				<a style="color: #C0392B;" href="${ctx}/web/oa/materia_v2/applySy">返回</a>
			</div>
		</c:if>
		<c:if test="${type == 2}">
			<div class="lzui-tooltips"
				...
				<a style="color: #C0392B;"
					href="${ctx}/web/oa/materia_v2/purchaseList">返回</a>
			</div>
		</c:if>
			...
			<table class="lzzUIGrid">
				<tbody>
					...
					<tr>
						...
						<td class="l-td-header" style="width: 20%;">审批状态</td>
					...
					<c:forEach items="${list}" var="cur">
						<tr>
							...
							<td class="l-td"><a
								href="${ctx }/web/oa/materia_v2/syDetail?id=${cur.id}&type=${type}">查看详情</a></td>
						</tr>
					</c:forEach>
