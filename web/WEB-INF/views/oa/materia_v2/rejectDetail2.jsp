...
<div
	...
	<div id="theNavigater">
		...
		<c:if test="${type == 1}">
			<div class="navTitle2" url="${ctx }/web/oa/materia_v2/rejectApprove">
				<img src="${ctx }/resources/images/item.png"
					style="vertical-align: middle; width: 20px; height: 20px;" />&nbsp;&nbsp;返回上级
			</div>
		</c:if>
		<c:if test="${type == 2}">
			<div class="navTitle2" url="${ctx }/web/oa/materia_v2/rejectList3">
				<img src="${ctx }/resources/images/item.png"
					style="vertical-align: middle; width: 20px; height: 20px;" />&nbsp;&nbsp;返回上级
			</div>
		</c:if>
	...
	<div style="margin: 10px 5px 0 195px;">
		...
		<div id="print">
			<form name="form1" action="${ctx }/web/oa/materia_v2/rejectApprove" id="form1"
				method="post" >
						...
						<tbody>
							...
							<c:forEach items="${list}" var="cur">
								<tr align="center">
									...
									<td style="">${cur.maCode }<input type="hidden" value="${cur.id }" name="ids" />
									</td>
					...
					<table class="table1">
						...
						<tr>
							<c:choose>
								...
								<c:when test="${empty approve2 and ma.status > 2}">
									<td style="width: 10%;">二级主管审批结果 
										<span style="color: red;"></span>
									</td>
									<td style="width: 15%;"><span style="color: gray;">本次审批不需要经过此流程</span></td>
