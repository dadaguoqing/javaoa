	...
	<div style="margin: 10px 5px 0 195px;">
		...
		<div class="lzui-tooltips"
			...
			<a style="color: #C0392B;"
				href="${ctx}/web/oa/materia_v2/rejectList">查看申请记录</a>
		</div>
		<div style="border: 1px solid #2191C0;">
			<form name="form1" action="${ctx }/web/oa/materia_v2/saveReject"
					...
					<tbody id="data">
						...
						<tr>
							...
							<td align="center" style="width: 50px">
								<a onclick="add();" href="javascript:void(0)">添加</a>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<table class="table1">
					<tbody>
						<tr>
							<td style="border-right: none;"><textarea name="content" id="bz"
...
<script>
	...
	function add() {
		...
		tr += '<td>' + code+ '<input type="hidden" name="maCode" value="'+code+'"/></td>';
		tr += '<td name="spec">' + $('#spec0').html() + '<input type="hidden" name="spec" value="'+ $('#spec0').html() +'"/></td>';
