...
<div
	...
	<div id="theNavigater">
		...
		<div class="navTitle2" url="${ctx }/web/oa/materia_v2/applyRecord">
			<img src="${ctx }/resources/images/item.png"
					...
					<table class="table1">
						<tbody>
							...
							<c:forEach items="${list}" var="cur">
								<tr align="center">
									<td style="" align="left">${cur.materiaCode }</td>
...
<!-- 				<a href="javascript:cancle();" class="lzui-btn lzui-corner-all">撤销</a> -->
<%-- 			</c:if> --%>
		</div>
	</div>
