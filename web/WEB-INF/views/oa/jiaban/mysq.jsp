...
<div style="margin: 10px 5px 0 195px;">
	...
	<div class="lzui-tooltips" style="margin:10px; color:#C0392B; font-weight:bold; font-size:14px;">
  		<a style="color:#C0392B;" href="${ctx}/web/oa/jiaban/sq">点击申请加班</a>
  	</div>
  	
	<div class="gridContainer" style="width:95%; margin-left:0px;margin-top:0px;">
	<table class="lzzUIGrid"><tbody>
		...
		<tr>
			...
			<td class="l-td-header" style="width:170px;">加班时间</td>
			<td class="l-td-header" style="width:170px;">加班时长</td>
    	...
    	<c:forEach items="${list}" var="cur">
    		<tr>
				...
				<td class="l-td l-td-last-right" style="">
					<a href="${ctx }/web/oa/jiaban/info/${cur.id}">查看详情</a>
				</td>
    		</tr>
    	</c:forEach>
