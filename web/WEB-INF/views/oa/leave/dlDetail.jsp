...
<div id="theNavigater">
	...
	<div class="navTitle2" url="${ctx }/web/oa/leave/mydl"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;返回上级</div>
</div>
...
<div style="margin: 10px 5px 0 195px;">
	...
	<table class="table1" ><tbody>
		<tr>
			<td class="title" style="width:150px">代理人：</td>	
			<td >
				${AllUsers[leave.dailiId].name}
			</td>	
