...
<div
	...
	<div id="theNavigater">
		...
		<div class="navTitle2" url="${ctx }/web/oa/leave/findAllXj?curpage=1"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;返回上级</div>
	</div>
