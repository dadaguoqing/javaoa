...
<div style="margin: 10px 5px 0 195px;">
	...
	<div class="lzui-tooltips" style="margin:10px; color:#C0392B; font-weight:bold; font-size:14px;">
  		<a style="color:#C0392B;" href="${ctx}/web/oa/leave/alfs">点击这里返回代理请假</a>
  	</div>
	...
	<table class="lzzUIGrid"><tbody>
		...
		<tr>
			...
			<td class="l-td-header l-td-left l-td-last-right" style="">审核状态</td>
			<td class="l-td-header l-td-left l-td-last-right" style="">操作</td>
		</tr>
    	...
    	<c:forEach items="${list}" var="cur">
    		<tr>
				...
				<td class="l-td l-td-left l-td-last-right">
    				<c:choose>
				...
				<td class="l-td"><a  href="${ctx}/web/oa/leave/mydldeatil?id=${cur.id}">查看详情</a></td>
    		</tr>
