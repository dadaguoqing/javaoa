...
<div id="theNavigater">
	...
	<div class="navTitle2" url="${ctx }/web/oa/bingjia/record"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;返回上级</div>
	</c:if>
	
	<c:if test="${leave.type != '病假' }">
	<div class="navTitle2" url="${ctx }/web/oa/nianjia/record"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;返回上级</div>
	</c:if>	
</div>
...
<form name="form1" action="${ctx }/web/oa/leave/showForNjRecordByDate" method="post">
