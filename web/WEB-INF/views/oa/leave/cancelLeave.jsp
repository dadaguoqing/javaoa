...
<div id="theNavigater">
	...
	<div class="navTitle2" url="${ctx }/web/oa/leave/goCancelLeave"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;返回上级</div>
</div>
...
<div style="margin: 10px 5px 0 195px;">
	...
	<form name="form1" action="${ctx }/web/oa/leave/cancel1" method="post">
	...
	<table class="table1" ><tbody>
		<tr>
			<td class="title" style="border-left:none; width:90px;">销假时间：</td>	
			<td style="width:260px;">
				<%@ include file="../public/beginTime.jsp" %>
			</td>	
			<td class="title" style="width:90px;">销假方式：</td>	
			<td  style="border-right:none; ">
				<select name="cancelType">
					<option value="0">提前回来</option>
					<option value="1">请假延后</option>
				</select>
			</td>	
		</tr>
	</tbody></table>
	...
	<div class="" style="margin-top:10px; margin-bottom:20px;">
		<a href="javascript:submitForm();" class="lzui-btn lzui-corner-all">销假</a>
		<!--  
