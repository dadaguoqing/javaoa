...
<div style="margin: 10px 5px 0 195px;">
	...
	<table class="table1" ><tbody>
		...
		<tr>
			<td class="title" style="width:90px;">剩余年假：</td>
			<td class="" colspan="3"><span style="color:red">${nianjia.nianjiaStr}</span></td>
			<td class="title" style="width:90px;">剩余病假：</td>
			<td style="border-right:none;" colspan="3"><span style="color:red">${nianjia.bingjiaStr}</span></td>
		</tr>
	</tbody></table>
