...
<div id="theNavigater">
	...
	<div class="navTitle2" url="${ctx }/web/oa/leave/myLeaves"><img src="${ctx }/resources/images/item.png" style="vertical-align:middle;width:20px;height:20px;"/>&nbsp;&nbsp;返回上级</div>
</div>
...
<div style="margin: 10px 5px 0 195px;">
	...
	<table class="table1" ><tbody>
		<tr>
			...
			<td>
				<span id="deptSpan">${deptName }</span>
			</td>	
...
<form name="leaveForm" action="${ctx}/web/oa/leave/empRecords" method="post">
		<input type="hidden" value="${leave.proposer }" name="empId"/>
	</form>
</body>
</html>
